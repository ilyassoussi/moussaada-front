...
import armori from '../../../assets/ArmoiriesduMaroc.svg';
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="block bg-gradient-to-r from-lime-400 to-green-400 bg-clip-text text-transparent mt-2">{t("appName.appname")}</span>
          </motion.h1>
          <motion.p 
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <div className="relative aspect-video rounded-xl shadow-2xl overflow-hidden group">
                ...
                <div className="absolute bottom-4 left-4 bg-white/80 backdrop-blur-sm p-3 rounded-lg shadow-md">
                    <img src={armori} className="w-10 h-10 text-green-600" />
                </div>
              </div>
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold text-green-800 mb-6 flex items-center">
                <Users className="w-8 h-8 mr-3 text-lime-600" /> {t("Home.about_title")}
              </h2>
              <p className="text-gray-700 mb-4 leading-relaxed">
                {t("Home.about_paragraph_1")}
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                {t("Home.about_paragraph_2")}
              </p>
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="flex items-center space-x-2 text-green-700">
                    <Tractor className="w-5 h-5 text-lime-600" /> <span>{t("Home.advanced_technology")}</span>
                </div>
                <div className="flex items-center space-x-2 text-green-700">
                    <TrendingUp className="w-5 h-5 text-lime-600" /> <span>{t("Home.optimized_yields")}</span>
                </div>
                <div className="flex items-center space-x-2 text-green-700">
                    <Leaf className="w-5 h-5 text-lime-600" /> <span>{t("Home.sustainable_practices")}</span>
                </div>
                 <div className="flex items-center space-x-2 text-green-700">
                    <Users className="w-5 h-5 text-lime-600" /> <span>{t("Home.expert_support")}</span>
                </div>
              </div>
